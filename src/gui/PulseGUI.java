...
import waveGenerators.PulseWave;

public class PulseGUI extends GenWidget {
	...
	public PulseGUI() {
		super("Pulse Wave Generator");
		
		wave = new PulseWave(frequency);
		...
		GridPane.setHalignment(freqSL, HPos.LEFT);
